    ...
    public function index()
{
    ...
    if (request()->ajax()) {
        return view('traiteur.services.menu.index_content', compact('menus'));
    }
    ...
    return view('traiteur.gerer_services', [
        ...
        'contentView' => view('traiteur.services.menu.index_content', compact('menus'))->render()
    ]);
}

    public function create()
    {
        return view('traiteur.menus.create');
    }
    ...
    public function store(MenuRequest $request)
    {
        ...
        return redirect()->route('traiteur.menus.show', $menu->id)
    ...
    public function show($id)
    {
        ...
        if (Auth::user()->traiteur->id != $menu->traiteur_id) {
            return redirect()->route('traiteur.menus.index')
                ->with('error', 'Vous n\'êtes pas autorisé à voir ce menu.');
        }

        return view('traiteur.menus.show', compact('menu'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('traiteur.menus.edit', compact('menu'));
    }
    ...
    public function update(MenuRequest $request, $id)
    {
        ...
        return redirect()->route('traiteur.menus.show', $id)
    ...
    public function createMenuItem($menuId)
    {
        ...
        return view('traiteur.menus.items.create', compact('menu'));
    }
    public function storeMenuItem(MenuItemRequest $request, $menuId)
    {
        ...
        return redirect()->route('traiteur.menus.show', $menuId)
    ...
    public function editMenuItem($menuId, $itemId)
    {
        ...
        return view('traiteur.menus.items.edit', compact('menu', 'menuItem'));
    }
