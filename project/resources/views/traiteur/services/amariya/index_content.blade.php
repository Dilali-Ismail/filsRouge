                    ...
                    <div class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-all duration-300 transform group-hover:-translate-y-1 h-full flex flex-col">
                        ...
                        <div class="relative h-48">
                            ...
                            <div class="absolute top-0 right-0 mt-2 mr-2 flex gap-1">
                                <a href="{{ route('traiteur.services.amariya.edit', $amariya->id) }}" class="p-2 bg-blue-100 hover:bg-blue-200 text-blue-700 rounded-full transition duration-300" title="Modifier" onclick="event.stopPropagation()">
                        ...
                        <div class="p-4 flex-grow">
                            <h3 class="text-lg font-semibold text-[#333333] mb-2 group-hover:text-[#C08081]">{{ $amariya->name }}</h3>
                        ...
                        <div class="px-4 pb-4 mt-auto">
                            <a href="{{ route('traiteur.services.amariya.show', $amariya->id) }}" class="block w-full text-center py-2 bg-gray-100 hover:bg-[#FADADD]/30 text-gray-700 hover:text-[#C08081] rounded-lg transition duration-300 text-sm font-medium">
                                Voir les détails
