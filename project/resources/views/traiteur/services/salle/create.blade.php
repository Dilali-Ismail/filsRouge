...
@section('title', 'Ajouter une salle de réception')
    ...
    <div class="container mx-auto px-4">
        <div class="max-w-3xl mx-auto">
            <div class="flex items-center mb-6">
                ...
                <h1 class="text-3xl font-bold text-[#333333] font-display">Ajouter une salle de réception</h1>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-md p-8">
                <form action="{{ route('traiteur.services.salle.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name') }}" required
                                ...
                                placeholder="Ex: Salle Royale, Palais des Roses, etc.">
                        ...
                        <div>
                            <label for="price" class="block text-sm font-medium text-[#333333] mb-2">
                                Prix de location (DH) <span class="text-red-500">*</span>
                            </label>
                        ...
                        <div>
                            ...
                            <input type="text" name="location" id="location" value="{{ old('location') }}" required
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#FADADD] focus:border-[#FADADD]"
                                placeholder="Ex: Quartier Anfa, Casablanca">
                        ...
                        <div>
                            <label for="tables_count" class="block text-sm font-medium text-[#333333] mb-2">
                                Nombre de tables disponibles <span class="text-red-500">*</span>
                            </label>
                            <input type="number" name="tables_count" id="tables_count" value="{{ old('tables_count') }}" required min="1" step="1"
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#FADADD] focus:border-[#FADADD]"
                                placeholder="Ex: 30">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="description" id="description" rows="6"
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#FADADD] focus:border-[#FADADD]"
                                placeholder="Décrivez cette salle, ses caractéristiques et équipements...">{{ old('description') }}</textarea>
